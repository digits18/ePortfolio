...
function validateForm() {
  ...
  const showError = (field, errorText) => {
    field.classList.add("error"); // Adds "error" class directly to the input field
  ...
  document.querySelectorAll(".email-form .error").forEach(field => field.classList.remove("error"));
  ...
  if (subject === "") {
    showError(subjectInput, "Enter subject");
    hasError = true;
  }
